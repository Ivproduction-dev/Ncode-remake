...
public static class NcodeColor
{
    ...
    [
        ...
        "для", "каждого", "каждый", "попробовать", "поймать",
    ...
    [
        ...
        "вещать", "вешать", "всем", "создать", "создай", "открыть",
        "остановить", "останови", "прервать", "прерви", "продолжить", "продолжи",
        "выйти", "выход", "закончить", "завершить",
        "ждать", "жди", "добавить", "добавь", "взять", "удалить", "удали",
        "очистить", "очисти", "записать", "запиши", "прочитать", "прочитай",
        "подключить", "подключи", "длина", "найти", "заменить", "срез",
        "верхний", "нижний", "случайное", "есть", "корень", "модуль", "округлить",
        "шаг", "раз", "от", "до", "файл", "список", "минуту", "минуты", "минут",
